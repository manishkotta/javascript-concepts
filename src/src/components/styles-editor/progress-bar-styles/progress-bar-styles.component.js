...
export default class ProgressBarStyles extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
                        ...
                        <div className="col-sm-12 col-md-12">
                            <div className="form-group">
                                <div className="row">
                                    ...
                                    <div className="col-sm-7 col-md-4">
                                        <input type="text" className="form-control" value={this.state.widget.title} onChange={(e) => this.updateWidgetTitle(e)} />
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    updateRangeValueFontSize(e) {
        const widget = this.state.widget;
        widget.rangeValueStyles.fontSize = isNaN(+e.target.value) ?  10 : +e.target.value ;
        this.setState({ widget });
    }
