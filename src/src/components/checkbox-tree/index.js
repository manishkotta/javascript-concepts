...
var TreeNode = function (_React$Component) {
	...
	_createClass(TreeNode, [{
		...
		value: function renderCollapseIcon() {
			if (this.hasChildren()){
				if (!this.props.expanded) {
					return _react2.default.createElement('i', { className: 'rct-icon fa fa-plus rct-icon-expand-close', onClick: this.onExpand  });
				}

				return _react2.default.createElement('i', { className: 'rct-icon fa fa-minus rct-icon-expand-open', onClick: this.onExpand  });
			}
		}
	}, {
		...
		value: function renderCollapseButton() {
			if (!this.hasChildren()) {
				return _react2.default.createElement(
					...
					_react2.default.createElement('i', { className: 'rct-icon' })
				);
			}
		...
		value: function renderCheckboxIcon() {
			if (this.props.checked === 0) {
				return _react2.default.createElement('i', { className: 'rct-icon rct-icon-uncheck' });
			}

			if (this.props.checked === 1) {
				return _react2.default.createElement('i', { className: 'rct-icon rct-icon-check' });
			}

			return _react2.default.createElement('i', { className: 'rct-icon rct-icon-half-check' });
		}
	}, {
		key: 'renderNodeIcon',
		value: function renderNodeIcon() {
			...
			if (!this.props.expanded) {
				return _react2.default.createElement('i', { className: 'rct-icon rct-icon-parent-close' });
			}

			return _react2.default.createElement('i', { className: 'rct-icon rct-icon-parent-open' });
		}
	}, {
		key: 'renderChildren',
