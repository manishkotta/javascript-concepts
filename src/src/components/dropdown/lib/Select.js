...
var Select = _react2['default'].createClass({
	...
	componentWillReceiveProps: function componentWillReceiveProps(nextProps) {
		//this.props.value !== undefined && nextProps.value !== undefined && this.props.value !== nextProps.value
		//if (nextProps.value !== undefined && JSON.stringify(this.props.value) !==JSON.stringify(nextProps.value)) {
  ...
  */
	...
	renderValue: function renderValue(valueArray, isOpen) {
		...
		// to make sure placeholder is present when we set {} as default value
		else if(_.isEqual(valueArray[0], {})){
			return !this.state.inputValue ? _react2['default'].createElement(
			 'div',
			 { className: 'Select-placeholder' },
			 this.props.placeholder
